#'Column Names
#'
#'Create a data.frame of column names for water-quality constituents
#'
#'@return A data frame containing the columns \code{parm_cd} and
#'\code{col_name}.
#'@note This function is intended to create a user-modifiable data.frame
#'called pcode.ColNames instead of accpeting the default column names.
#'@seealso \code{\link{pcodeNWISqw}}
#'@keywords utilities
#'@export
